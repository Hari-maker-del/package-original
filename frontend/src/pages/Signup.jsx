...
function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    setSubmitting(true);
    try {
      await signup({ name: fullName, email, password, accountType });
            ...
            <div className="max-w-md w-full mx-auto">
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 px-4 py-3">
                  <p className="text-sm font-medium text-slate-700">Account type: User</p>
                  <p className="text-xs text-slate-500 mt-1">Compliance Officer access is assigned by an administrator.</p>
                </div>
